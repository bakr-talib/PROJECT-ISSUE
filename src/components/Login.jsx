      ...
      {!showSignUp ? (
        <>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className="w-full bg-[var(--primary-color)] text-[var(--contrasting-color)] p-2 rounded"
            >
              Login
            </button>
          </form>
          <button
            className="w-full bg-[var(--secondary-color)] text-[var(--contrasting-color)] p-2 rounded mt-4"
